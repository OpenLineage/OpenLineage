...
public class LibraryTest {
  ...
  public void testSparkSql() throws IOException, TimeoutException {
    when(sparkContext.getJobNamespace()).thenReturn("ns_name");
    when(sparkContext.getParentJobName()).thenReturn("job_name");
    when(sparkContext.getParentRunId()).thenReturn("ea445b5c-22eb-457a-8007-01c7c52b6e54");
  ...
  public void testRdd() throws IOException {
    when(sparkContext.getJobNamespace()).thenReturn("ns_name");
    when(sparkContext.getParentJobName()).thenReturn("job_name");
    when(sparkContext.getParentRunId()).thenReturn("8d99e33e-2a1c-4254-9600-18f23435fc3b");
