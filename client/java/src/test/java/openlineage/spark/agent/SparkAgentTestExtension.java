...
public class SparkAgentTestExtension implements BeforeAllCallback, BeforeEachCallback {
  public static final OpenLineageSparkContext sparkContext = mock(OpenLineageSparkContext.class);
  ...
  public void beforeAll(ExtensionContext context) throws Exception {
    ...
    SparkAgent.premain(
        ...
        new StaticExecutionContextFactory(sparkContext));
  }

  @Override
  public void beforeEach(ExtensionContext context) throws Exception {
    Mockito.reset(sparkContext);
  }
}
