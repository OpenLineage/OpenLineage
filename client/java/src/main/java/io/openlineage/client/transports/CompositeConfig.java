...
public final class CompositeConfig implements TransportConfig, MergeConfig<CompositeConfig> {
  ...
  @Getter @Setter private Boolean threadPoolActive;
  ...
  public CompositeConfig(
      ...
      @JsonProperty("threadPoolActive") Boolean threadPoolActive) {
    ...
    this.threadPoolActive = (threadPoolActive == null) ? true : threadPoolActive;
  }

  public static CompositeConfig createFromTransportConfigs(
      List<TransportConfig> transports, boolean continueOnFailure, boolean threadPoolActive) {
    CompositeConfig compositeConfig = new CompositeConfig();
    compositeConfig.setTransports(transports);
    compositeConfig.setContinueOnFailure(continueOnFailure);
    compositeConfig.setThreadPoolActive(threadPoolActive);
  ...
  public CompositeConfig mergeWithNonNull(CompositeConfig other) {
    ...
    Boolean mergedThreadPoolActive = mergePropertyWith(threadPoolActive, other.threadPoolActive);

    return createFromTransportConfigs(
        mergedTransports, mergedContinueOnFailure, mergedThreadPoolActive);
  }
}
