...
class ColumnMetrics(RedactMixin):
    nullCount: int | None = attr_field(default=None)  # noqa: N815
    """The number of null values in this column for the rows evaluated"""

    distinctCount: int | None = attr_field(default=None)  # noqa: N815
    """The number of distinct values in this column for the rows evaluated"""

    sum: float | None = attr_field(default=None)  # noqa: A003
    """The total sum of values in this column for the rows evaluated"""

    count: float | None = attr_field(default=None)
    """The number of values in this column"""

    min: float | None = attr_field(default=None)  # noqa: A003
    max: float | None = attr_field(default=None)  # noqa: A003
    quantiles: dict[str, float] | None = attr_field(factory=dict)
...
class DataQualityMetricsInputDatasetFacet(InputDatasetFacet):
    ...
    rowCount: int | None = attr_field(default=None)  # noqa: N815
    """The number of rows evaluated"""

    bytes: int | None = attr_field(default=None)  # noqa: A003
    """The size in bytes"""

    fileCount: int | None = attr_field(default=None)  # noqa: N815
    """The number of files evaluated"""

    lastUpdated: str | None = attr_field(default=None)  # noqa: N815
