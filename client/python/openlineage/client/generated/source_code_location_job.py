...
class SourceCodeLocationJobFacet(JobFacet):
    ...
    repoUrl: str | None = attr_field(default=None)  # noqa: N815
    """the URL to the repository"""

    path: str | None = attr_field(default=None)
    """the path in the repo containing the source files"""

    version: str | None = attr_field(default=None)
    """the current version deployed (not a branch name, the actual unique version)"""

    tag: str | None = attr_field(default=None)
    """optional tag name"""

    branch: str | None = attr_field(default=None)
