...
from datamodel_code_generator import DataModelType, PythonVersion  # type: ignore[import-not-found]
...
DATA_MODELS_TYPES = get_data_model_types(
    DataModelType.DataclassesDataclass, target_python_version=PythonVersion.PY_310
)
...
def parse_and_generate(
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        data_type_manager: pydantic_model.DataTypeManager = parser.data_type_manager
