...
func (x *IcebergCommitReport) WithCommitMetrics(commitMetrics CommitMetrics) *IcebergCommitReport {
	x.CommitMetrics = &commitMetrics

	return x
}
func (x *IcebergCommitReport) WithOperation(operation string) *IcebergCommitReport {
	x.Operation = &operation

	return x
}
func (x *IcebergCommitReport) WithSequenceNumber(sequenceNumber float64) *IcebergCommitReport {
	x.SequenceNumber = &sequenceNumber

	return x
}
func (x *IcebergCommitReport) WithSnapshotID(snapshotId float64) *IcebergCommitReport {
...
func (x *IcebergScanReport) WithFilterDescription(filterDescription string) *IcebergScanReport {
	x.FilterDescription = &filterDescription

	return x
}
func (x *IcebergScanReport) WithProjectedFieldNames(projectedFieldNames []string) *IcebergScanReport {
	x.ProjectedFieldNames = projectedFieldNames

	return x
}
func (x *IcebergScanReport) WithScanMetrics(scanMetrics ScanMetrics) *IcebergScanReport {
	x.ScanMetrics = &scanMetrics

	return x
}
func (x *IcebergScanReport) WithSchemaID(schemaId float64) *IcebergScanReport {
	x.SchemaID = &schemaId

	return x
}
func (x *IcebergScanReport) WithSnapshotID(snapshotId float64) *IcebergScanReport {
	x.SnapshotID = &snapshotId
...
func (x *GcpComposerJob) WithDeleted(deleted bool) *GcpComposerJob {
	x.Deleted = &deleted

	return x
}
func (x *GcpComposerJob) WithOperator(operator string) *GcpComposerJob {
	x.Operator = &operator

	return x
}
func (x *GcpComposerJob) WithTaskID(taskId string) *GcpComposerJob {
	x.TaskID = &taskId
...
func (x *GcpDataproc) WithBatchID(batchId string) *GcpDataproc {
	x.BatchID = &batchId

	return x
}
func (x *GcpDataproc) WithBatchUUID(batchUuid string) *GcpDataproc {
	x.BatchUUID = &batchUuid

	return x
}
func (x *GcpDataproc) WithClusterName(clusterName string) *GcpDataproc {
	x.ClusterName = &clusterName

	return x
}
func (x *GcpDataproc) WithClusterUUID(clusterUuid string) *GcpDataproc {
	x.ClusterUUID = &clusterUuid

	return x
}
func (x *GcpDataproc) WithJobID(jobId string) *GcpDataproc {
	x.JobID = &jobId

	return x
}
func (x *GcpDataproc) WithJobType(jobType string) *GcpDataproc {
	x.JobType = &jobType

	return x
}
func (x *GcpDataproc) WithJobUUID(jobUuid string) *GcpDataproc {
	x.JobUUID = &jobUuid

	return x
}
func (x *GcpDataproc) WithQueryNodeName(queryNodeName string) *GcpDataproc {
	x.QueryNodeName = &queryNodeName

	return x
}
func (x *GcpDataproc) WithSessionID(sessionId string) *GcpDataproc {
	x.SessionID = &sessionId

	return x
}
func (x *GcpDataproc) WithSessionUUID(sessionUuid string) *GcpDataproc {
	x.SessionUUID = &sessionUuid
...
func (x *GcpLineage) WithDeleted(deleted bool) *GcpLineage {
	x.Deleted = &deleted

	return x
}
func (x *GcpLineage) WithDisplayName(displayName string) *GcpLineage {
	x.DisplayName = &displayName

	return x
}
func (x *GcpLineage) WithOrigin(origin Origin) *GcpLineage {
	x.Origin = &origin
