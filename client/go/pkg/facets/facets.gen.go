...
type DataQualityMetricsDatasetFacet struct {
	...
	// An ISO-8601 timestamp representing the point in time at which these metrics were captured. All metrics in this facet (e.g. rowCount, columnMetrics) reflect the dataset state as of this time.
