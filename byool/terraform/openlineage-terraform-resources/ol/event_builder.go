...
func buildSymlinksFacet(symlinks []SymlinkModel) *facets.SymlinksDatasetFacet {
...
func buildCatalogFacet(c *CatalogModel) *facets.CatalogDatasetFacet {
...
func buildColumnLineageFacet(clm *ColumnLineageModel) *facets.ColumnLineageDatasetFacet {
