      ...
      <div className={`transition-all duration-300 hover:shadow-2xl shadow ${focused && "focused"}`}>
        ...
        >
          ...
          <div className="p-4 py-3">
            <h4 className="text-3xl pt-1">{data.frontMatter.title}</h4>
            ...
            <p className="pt-3 text-color-default">
              <strong>
                <small className="font-sans">{author}</small>
              </strong>
            </p>
            <p className="pt-3 text-color-default">{data.frontMatter.description}</p>
          </div>
        </Link>
      </div>
    </div>
