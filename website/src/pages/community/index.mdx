...
<div className="container text-center">
    <div className="row">
        <p>Join us on the <a href="https://join.slack.com/t/openlineage/shared_invite/zt-2u4oiyz5h-TEmqpP4fVM5eCdOGeIbZvA">OpenLineage Slack</a> to stay up-to-date on upcoming events, releases and discussions. The Slack community is a great place to ask questions and get to know OpenLineage contributors and users around the world.</p>
    </div>
</div>
