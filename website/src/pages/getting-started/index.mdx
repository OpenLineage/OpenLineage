...
image: https://openlineage.io/img/getting-started-thumb.png
---
<Head>
  <title>Getting Started | OpenLineage</title>
</Head>
...
What did you think of this guide? We would love to hear feedback, and we can be found on the [OpenLineage Slack](https://join.slack.com/t/openlineage/shared_invite/zt-3arpql6lg-Nt~hicnDsnDY_GK_LEX06w).
