...
- `captureDate`: An [ISO-8601](https://en.wikipedia.org/wiki/ISO_8601) timestamp of when these metrics were captured. All metrics in this facet reflect the dataset state as of this time.
