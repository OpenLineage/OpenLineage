...
export const Producers: Array<Partner> = [
  ...
  },
  {
    ...
    full_name: "Hamilton",
    description:
      "Using Hamilton's OpenLineageAdapter, you can automatically push data lineage information via any OpenLineage Client.",
  ...
  },
  {
    ...
    full_name: "SnapLogic",
    description:
      "SnapLogic's Data Lineage feature supports automated collection of data lineage metadata from SnapLogic Pipelines. This metadata is made available in Open Lineage format to the consumers.",
