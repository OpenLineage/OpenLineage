...
export const Consumers: Array<Partner> = [
  ...
  },
  {
    ...
    description:
      "Astronomer's Astro uses OpenLineage to extract lineage from Airflow tasks and stores that data in Astro Observe. Astro Observe renders the lineage metadata generated by your DAGs as a dynamic graph to provide visibility into the health and performance of your data pipelines.",
    docs_url: "https://www.astronomer.io/dataops-platform/",
  ...
  },
  {
    ...
    full_name: "Ataccama",
    description:
      "Ataccama leverages OpenLineage to enrich data lineage with metadata from data pipelines.",
