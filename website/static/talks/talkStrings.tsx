...
export const Talks: Array<Talk> = [
  ...
  },
  {
    ...
    speakers: ["Maciej Obuchowski, GetInData", "Pawel Leszczynski, Astronomer"],
  ...
  },
  {
    ...
    description: "In this session, Julien Le Dem will show how to trace data lineage across Apache Spark and Apache Airflow. He will walk through the OpenLineage architecture and provide a live demo of a running pipeline with real-time data lineage.",
  ...
  },
  {
    ...
    speakers: ["Julien Le Dem, OpenLineage"],
    description: "Julien Le Dem presented at Data Driven NYC in January 2021. He spoke about the need for an end-to-end management layer for data, how this strengthens the overall data ops landscape, and the launch of OpenLineage, a new effort to define such a flexible industry standard for data lineage.",
  ...
  },
  {
    ...
    speakers: ["Julien Le Dem, OpenLineage"],
    description: "Julien Le Dem co-created Apache Parquet and is involved in several open source projects including Marquez (LF AI), Apache Pig, Apache Arrow, Apache Iceberg and a few others. Previously, Julien was a senior principal at Wework; principal architect at Dremio; tech lead for Twitter’s data processing tools, where he also obtained a two-character Twitter handle (@J_); and a principal engineer and tech lead working on content platforms at Yahoo, where he received his Hadoop initiation. His French accent makes his talks particularly attractive.",
    video_url: "https://www.youtube.com/watch?v=MoW-YGjHLgI/",
