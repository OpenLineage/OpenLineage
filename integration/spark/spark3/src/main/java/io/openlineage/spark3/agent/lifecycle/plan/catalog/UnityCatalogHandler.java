...
/**
 * Handler for open source Unity Catalog catalog
 */
@Slf4j
public class UnityCatalogHandler implements CatalogHandler {
  private final OpenLineageContext context;

  public UnityCatalogHandler(OpenLineageContext context) {
  ...
  public boolean hasClasses() {
    try {
      UnityCatalogHandler.class
          .getClassLoader()
          .loadClass("io.unitycatalog.spark.UCSingleCatalog");
      return true;
    } catch (Exception e) {
  ...
  public boolean isClass(TableCatalog tableCatalog) {
    return tableCatalog instanceof UCSingleCatalog;
  }
