 ...
 */
public class ReplaceDataVisitor extends QueryPlanVisitor<ReplaceData, OutputDataset> {

  public ReplaceDataVisitor(OpenLineageContext context) {
    super(context);
  }
  ...
  public List<OutputDataset> apply(LogicalPlan x) {
    ...
    LogicalPlan table = (LogicalPlan) ((ReplaceData) x).table();
