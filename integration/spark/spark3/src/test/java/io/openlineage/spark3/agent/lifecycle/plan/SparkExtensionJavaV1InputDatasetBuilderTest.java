...
class SparkExtensionJavaV1InputDatasetBuilderTest {

  OpenLineage openLineage = new OpenLineage(Versions.OPEN_LINEAGE_PRODUCER_URI);
  OpenLineageContext context = mock(OpenLineageContext.class);
  SparkExtensionJavaV1InputDatasetBuilder builder;
  LogicalPlan plan =
  ...
  @SneakyThrows
  public void setUp() {
    builder = mock(SparkExtensionJavaV1InputDatasetBuilder.class);
