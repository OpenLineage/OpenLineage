...
class SparkExtensionJavaV1OutputDatasetBuilderTest {

  OpenLineage openLineage = new OpenLineage(Versions.OPEN_LINEAGE_PRODUCER_URI);
  OpenLineageContext context = mock(OpenLineageContext.class);
  SparkExtensionJavaV1OutputDatasetBuilder builder;
  LogicalPlan plan =
  ...
  @SneakyThrows
  public void setUp() {
    builder = mock(SparkExtensionJavaV1OutputDatasetBuilder.class);
