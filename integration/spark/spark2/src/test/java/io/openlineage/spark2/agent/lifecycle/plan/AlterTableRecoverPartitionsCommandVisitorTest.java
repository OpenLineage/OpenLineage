...
class AlterTableRecoverPartitionsCommandVisitorTest {
  ...
  @Test
  @SneakyThrows
  void testAlterTableRecoverPartitions() {
    ...
    try (MockedStatic mocked = mockStatic(SparkSession.class)) {
      ...
      AlterTableRecoverPartitionsCommandVisitor visitor =
          new AlterTableRecoverPartitionsCommandVisitor(openLinegeContext);

      AlterTableRecoverPartitionsCommand command =
          AlterTableRecoverPartitionsCommand$.MODULE$.apply(
              tableIdentifier, "ALTER TABLE RECOVER PARTITIONS");
