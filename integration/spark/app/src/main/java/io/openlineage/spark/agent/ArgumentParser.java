...
public class ArgumentParser {
  ...
  public static final String SPARK_CONF_ROOT_PARENT_JOB_NAMESPACE =
      "spark.openlineage.rootParentJobNamespace";
  public static final String SPARK_CONF_ROOT_PARENT_JOB_NAME =
  ...
  private static void extractSparkSpecificConfigEntriesFromSparkConf(
    ...
    findSparkConfigKey(conf, SPARK_CONF_ROOT_PARENT_JOB_NAMESPACE)
        .ifPresent(config::setRootParentJobNamespace);
    findSparkConfigKey(conf, SPARK_CONF_ROOT_PARENT_JOB_NAME)
        .ifPresent(config::setRootParentJobName);
