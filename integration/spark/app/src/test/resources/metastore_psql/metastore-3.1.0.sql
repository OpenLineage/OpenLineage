...
DROP TABLE IF EXISTS "BUCKETING_COLS" CASCADE;
...
DROP TABLE IF EXISTS  "DATABASE_PARAMS" CASCADE;
...
DROP TABLE IF EXISTS "CTLGS" CASCADE;
CREATE TABLE "CTLGS" (
...
--
DROP TABLE IF EXISTS "GLOBAL_PRIVS" CASCADE;
...
--
DROP TABLE IF EXISTS "IDXS" CASCADE; 
CREATE TABLE "IDXS" (
...
--
DROP TABLE IF EXISTS "INDEX_PARAMS" CASCADE;
...
--
DROP TABLE IF EXISTS "NUCLEUS_TABLES" CASCADE;
...
--
DROP TABLE IF EXISTS "PARTITION_EVENTS" CASCADE;
...
--
DROP TABLE IF EXISTS "PARTITION_KEY_VALS" CASCADE;
...
--
DROP TABLE IF EXISTS "PART_COL_PRIVS" CASCADE;
...
--
DROP TABLE IF EXISTS "PART_PRIVS" CASCADE;
...
--
DROP TABLE IF EXISTS "SD_PARAMS" CASCADE;
...
--
DROP TABLE IF EXISTS "SERDES" CASCADE;
CREATE TABLE "SERDES" (
...
--
DROP TABLE IF EXISTS "SERDE_PARAMS" CASCADE;
...
--
DROP TABLE IF EXISTS "SORT_COLS" CASCADE;
...
--
DROP TABLE IF EXISTS "TABLE_PARAMS" CASCADE;
...
--
DROP TABLE IF EXISTS "MV_CREATION_METADATA" CASCADE;
...
--
DROP TABLE IF EXISTS "MV_TABLES_USED" CASCADE;
...
--
DROP TABLE IF EXISTS "TBL_COL_PRIVS" CASCADE;
...
--
DROP TABLE IF EXISTS "TYPE_FIELDS" CASCADE;
...
DROP TABLE IF EXISTS "SKEWED_STRING_LIST" CASCADE;
CREATE TABLE "SKEWED_STRING_LIST" (
    "STRING_LIST_ID" bigint NOT NULL
);

DROP TABLE IF EXISTS "SKEWED_STRING_LIST_VALUES" CASCADE;
...
DROP TABLE IF EXISTS "SKEWED_COL_NAMES" CASCADE;
...
DROP TABLE IF EXISTS "SKEWED_COL_VALUE_LOC_MAP" CASCADE;
...
DROP TABLE IF EXISTS "SKEWED_VALUES" CASCADE;
...
DROP TABLE IF EXISTS "TAB_COL_STATS" CASCADE;
...
--
DROP TABLE IF EXISTS "PART_COL_STATS" CASCADE;
...
--
DROP TABLE IF EXISTS "FUNCS" CASCADE;
CREATE TABLE "FUNCS" (
...
--
DROP TABLE IF EXISTS "FUNC_RU" CASCADE;
...
DROP TABLE IF  EXISTS "NOTIFICATION_SEQUENCE" CASCADE;
...
DROP TABLE IF EXISTS "KEY_CONSTRAINTS" CASCADE;
...
---
DROP TABLE IF EXISTS "METASTORE_DB_PROPERTIES" CASCADE;
...
DROP TABLE IF EXISTS "WM_RESOURCEPLAN" CASCADE;
...
DROP TABLE IF EXISTS "WM_POOL" CASCADE;
...
DROP TABLE IF EXISTS "WM_TRIGGER" CASCADE;
...
DROP TABLE IF EXISTS "WM_POOL_TO_TRIGGER" CASCADE;
CREATE TABLE "WM_POOL_TO_TRIGGER" (
    "POOL_ID" bigint NOT NULL,
    "TRIGGER_ID" bigint NOT NULL
);

DROP TABLE IF EXISTS "WM_MAPPING" CASCADE;
...
CREATE INDEX "SKEWED_STRING_LIST_VALUES_N49" ON "SKEWED_STRING_LIST_VALUES" USING BTREE ("STRING_LIST_ID");
...
CREATE INDEX "SKEWED_VALUES_N49" ON "SKEWED_VALUES" USING BTREE ("STRING_LIST_ID_EID");

CREATE INDEX "SKEWED_VALUES_N50" ON "SKEWED_VALUES" USING BTREE ("SD_ID_OID");    
...
--
-- Name: TAB_COL_STATS_50; Type: INDEX; Schema: public; Owner: hiveuser; Tablespace:
--

CREATE INDEX "TAB_COL_STATS_N50" ON "TAB_COL_STATS" USING btree ("CAT_NAME","DB_NAME","TABLE_NAME","COLUMN_NAME");
...
CREATE INDEX "SKEWED_COL_NAMES_N49" ON "SKEWED_COL_NAMES" USING BTREE ("SD_ID");

ALTER TABLE ONLY "SKEWED_COL_NAMES"
    ADD CONSTRAINT "SKEWED_COL_NAMES_fkey" FOREIGN KEY ("SD_ID") REFERENCES "SDS"("SD_ID") DEFERRABLE;

CREATE INDEX "SKEWED_COL_VALUE_LOC_MAP_N49" ON "SKEWED_COL_VALUE_LOC_MAP" USING BTREE ("STRING_LIST_ID_KID");
CREATE INDEX "SKEWED_COL_VALUE_LOC_MAP_N50" ON "SKEWED_COL_VALUE_LOC_MAP" USING BTREE ("SD_ID");
...
DROP TABLE IF EXISTS MATERIALIZATION_REBUILD_LOCKS CASCADE;
...
DROP TABLE IF EXISTS TXN_COMPONENTS CASCADE;
...
CREATE INDEX TC_TXNID_INDEX ON TXN_COMPONENTS USING btree (TC_TXNID);

DROP TABLE IF EXISTS COMPLETED_TXN_COMPONENTS CASCADE;
...
DROP TABLE IF EXISTS NEXT_TXN_ID CASCADE;
CREATE TABLE NEXT_TXN_ID (
  NTXN_NEXT bigint NOT NULL
);
INSERT INTO NEXT_TXN_ID VALUES(1);

DROP TABLE IF EXISTS HIVE_LOCKS CASCADE;
...
CREATE INDEX HIVE_LOCK_TXNID_INDEX ON HIVE_LOCKS USING btree (HL_LOCK_INT_ID);


CREATE INDEX HL_TXNID_INDEX ON HIVE_LOCKS USING btree (HL_TXNID);

DROP TABLE IF EXISTS NEXT_LOCK_ID CASCADE;
CREATE TABLE NEXT_LOCK_ID (
  NL_NEXT bigint NOT NULL
);
INSERT INTO NEXT_LOCK_ID VALUES(1);

DROP TABLE IF EXISTS COMPACTION_QUEUE CASCADE;
...
DROP TABLE IF EXISTS NEXT_COMPACTION_QUEUE_ID CASCADE;
...
DROP TABLE IF EXISTS COMPLETED_COMPACTIONS CASCADE;
...
DROP TABLE IF EXISTS AUX_TABLE CASCADE;
...
DROP TABLE IF EXISTS WRITE_SET CASCADE;
...
DROP TABLE IF EXISTS TXN_TO_WRITE_ID CASCADE;
...
DROP TABLE IF EXISTS NEXT_WRITE_ID CASCADE;
...
DROP TABLE IF EXISTS MIN_HISTORY_LEVEL CASCADE;
...
DROP TABLE IF EXISTS I_SCHEMA CASCADE;
...
CREATE INDEX "DB_ID_N49" ON I_SCHEMA USING btree ("DB_ID");

ALTER TABLE ONLY I_SCHEMA
    ADD CONSTRAINT "UNIQUE_NAME" UNIQUE ("NAME");

ALTER TABLE ONLY I_SCHEMA
    ADD CONSTRAINT "I_SCHEMA_IBFK_1" FOREIGN KEY ("DB_ID") REFERENCES "DBS" ("DB_ID") DEFERRABLE;
...
CREATE INDEX IDX_CD_ID ON SCHEMA_VERSION using btree("CD_ID");
CREATE INDEX IDX_SERDE_ID ON SCHEMA_VERSION using btree("SERDE_ID");

DROP TABLE IF EXISTS REPL_TXN_MAP CASCADE;
...
DROP TABLE IF EXISTS RUNTIME_STATS CASCADE;
...
CREATE INDEX IDX_RUNTIME_STATS_CREATE_TIME ON RUNTIME_STATS using btree("CREATE_TIME");
