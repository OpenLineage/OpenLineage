 ...
 * For example: {@code -Dopenlineage.test.bucketName=my-bucket-name}. Most parameters have defaults.
 * For a full list of configurable parameters, see {@link EmrDynamicParameter}.
 *
