...
/**
 * Custom Condition written for recursive comparison of Map and List with ability to ignore
 * specified Map keys AssertJ Built-in recursive comparison is not working with Map type, it can
 * ignore only object properties Example usage: assertThat(actualMap).satisfies(new
