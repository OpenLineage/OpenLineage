...
class EventEmitterTest {
  ...
  //            .set(ArgumentParser.SPARK_CONF_HTTP_URL,
  ...
  //    SparkConf conf = new SparkConf().set(ArgumentParser.SPARK_CONF_HTTP_URL,
  // "https://localhost:5000/api/v1/namespaces/ns_name/jobs/job_name/runs/"
  ...
  //    EventEmitter ctx = new EventEmitter(argPars);
  ////    assertEquals(
  ////        URI.create("https://localhost:5000/api/v1/lineage?code=123&foo=bar"),
  // ctx.getLineageURI());
  //  }
}
