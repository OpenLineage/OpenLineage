...
//        objectMapper.readValue(logicalPlanSerializer.serialize(logicalRelation),
// mapTypeReference);
//
...
//        .satisfies(new MatchesMapRecursively(expectedCommandNode,
// Collections.singleton("exprId")));
...
//            config,
//            TableInfo.newBuilder(TableId.of("dataset", "test"), new
// TestTableDefinition()).build(),
