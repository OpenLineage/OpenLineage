...
class CreateTableAsSelectVisitorTest {
  ...
  private CreateTableAsSelect getCTAS(TableCatalog tableCatalog) {
  ...
  void testCreateTableAsSelectJdbcCommand() throws IllegalAccessException {
    ...
    CreateTableAsSelect command = getCTAS(tableCatalog);
  ...
  void testCreateTableAsSelectIcebergHadoopCommand(
    ...
    CreateTableAsSelect command = getCTAS(sparkCatalog);
