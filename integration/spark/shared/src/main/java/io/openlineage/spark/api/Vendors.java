...
public interface Vendors {
  List<String> VENDORS =
      Arrays.asList(
          ...
          "io.openlineage.spark.vendor.iceberg.IcebergVendor",
          "io.openlineage.spark32.vendor.iceberg.IcebergVendorSpark32",
          "io.openlineage.spark33.vendor.iceberg.IcebergVendorSpark33");
