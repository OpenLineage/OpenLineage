...
public class DatasetMapperUtils {
  ...
  public static DatasetUrn getUrn(OpenLineage.Dataset input) {
    return new DatasetUrn(
        new DataPlatformUrn(getPlatform(input)), input.getName(), FabricType.NON_PROD);
  }
  ...
  public static SchemaField getSchemaField(OpenLineage.SchemaDatasetFacetFields f) {
    ...
    return new SchemaField()
        .setFieldPath(f.getName())
        .setType(new SchemaFieldDataType().setType(value))
        .setNativeDataType(f.getType());
  }
}
