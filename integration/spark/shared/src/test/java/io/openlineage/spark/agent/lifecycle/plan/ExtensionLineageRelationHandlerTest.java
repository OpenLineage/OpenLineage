...
class ExtensionLineageRelationHandlerTest {
  OpenLineageContext openLineageContext = mock(OpenLineageContext.class);
  DatasetFactory datasetFactory = DatasetFactory.input(openLineageContext);
  ExtensionLineageRelationHandler<InputDataset> handler =
      new ExtensionLineageRelationHandler<>(openLineageContext, datasetFactory);
