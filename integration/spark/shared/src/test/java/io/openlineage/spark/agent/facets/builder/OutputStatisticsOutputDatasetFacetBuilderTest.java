    ...
    OutputStatisticsOutputDatasetFacetBuilder builder =
        new OutputStatisticsOutputDatasetFacetBuilder(
            OpenLineageContext.builder()
                ...
                .build());
    Assertions.assertThat(builder.isDefinedAt(new SparkListenerJobEnd(1, 1L, JobSucceeded$.MODULE$))).isTrue();
    Assertions.assertThat(builder.isDefinedAt(new SparkListenerSQLExecutionEnd(1L, 1L))).isFalse();
  }
