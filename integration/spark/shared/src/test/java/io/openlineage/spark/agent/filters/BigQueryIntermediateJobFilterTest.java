...
class BigQueryIntermediateJobFilterTest {
  ...
  @ValueSource(
      strings = {
        "gs://bucket/.spark-bigquery-123e4567-e89b-12d3-a456-426614174000",
        "gs://bucket/.spark-bigquery-local-123e4567-e89b-12d3-a456-426614174000",
        "gs://bucket/.spark-bigquery-spark-123e4567-e89b-12d3-a456-426614174000",
        "gs://bucket/.spark-bigquery-application-123e4567-e89b-12d3-a456-426614174000",
        "gs://bucket/.spark-bigquery-spark-application-123e4567-e89b-12d3-a456-426614174000",
      })
  void isDisabled(String path) {
    // spark applicationId is generated by SchedulerBackend and not consistent between
    // implementations
    when(queryExecution.optimizedPlan()).thenReturn(insert);
    when(insert.outputPath()).thenReturn(new Path(path));
