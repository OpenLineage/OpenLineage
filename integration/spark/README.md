...
```groovy
implementation 'io.openlineage:openlineage-spark:0.29.2'
```
...
spark = (SparkSession.builder.master('local')
         ...
         .config('spark.jars.packages', 'io.openlineage:openlineage-spark:0.29.2')
...
file = "/home/jovyan/openlineage/libs/openlineage-spark-0.29.2.jar"
