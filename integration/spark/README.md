...
```groovy
implementation 'io.openlineage:openlineage-spark:0.30.1'
```
...
spark = (SparkSession.builder.master('local')
         ...
         .config('spark.jars.packages', 'io.openlineage:openlineage-spark:0.30.1')
...
file = "/home/jovyan/openlineage/libs/openlineage-spark-0.30.1.jar"
