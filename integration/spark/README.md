...
```groovy
implementation 'io.openlineage:openlineage-spark:0.25.0'
```
...
spark = (SparkSession.builder.master('local')
         ...
         .config('spark.jars.packages', 'io.openlineage:openlineage-spark:0.25.0')
...
file = "/home/jovyan/openlineage/libs/openlineage-spark-0.25.0.jar"
