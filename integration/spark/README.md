...
```groovy
implementation 'io.openlineage:openlineage-spark:0.15.0'
```
...
spark = (SparkSession.builder.master('local')
         ...
         .config('spark.jars.packages', 'io.openlineage:openlineage-spark:0.15.0')
...
file = "/home/jovyan/openlineage/libs/openlineage-spark-0.15.0.jar"
