...
```groovy
implementation 'io.openlineage:openlineage-spark:0.20.5'
```
...
spark = (SparkSession.builder.master('local')
         ...
         .config('spark.jars.packages', 'io.openlineage:openlineage-spark:0.20.5')
...
file = "/home/jovyan/openlineage/libs/openlineage-spark-0.20.5.jar"
