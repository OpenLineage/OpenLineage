...
```groovy
implementation 'io.openlineage:openlineage-spark:0.20.3'
```
...
spark = (SparkSession.builder.master('local')
         ...
         .config('spark.jars.packages', 'io.openlineage:openlineage-spark:0.20.3')
...
file = "/home/jovyan/openlineage/libs/openlineage-spark-0.20.3.jar"
