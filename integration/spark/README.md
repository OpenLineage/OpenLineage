...
```groovy
implementation 'io.openlineage:openlineage-spark:1.0.0'
```
...
file = "/home/jovyan/openlineage/libs/openlineage-spark-1.0.0.jar"
...
| spark.openlineage.appendDatasetNameToJobName | Decides whether output dataset name should be appended to job name. By default `true`.                                                                                             | false                               |
