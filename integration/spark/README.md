...
```groovy
implementation 'io.openlineage:openlineage-spark:0.5.0'
```
...
spark = (SparkSession.builder.master('local')
         ...
         .config('spark.jars.packages', 'io.openlineage:openlineage-spark:0.5.0')
...
file = "/home/jovyan/openlineage/libs/openlineage-spark-0.5.0.jar"
