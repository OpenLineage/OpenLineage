...
| spark.openlineage.capturedRuntimeProperties           | comma separated list of properties to be captured in SparkSession's RuntimeConfig                                                                                                  | "spark.example1,spark.example2"     |
