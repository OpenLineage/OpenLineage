...
public class ColumnLevelLineageTests extends ContainerHiveTestBase {
  ...
  void complexQueryCTEJoinsFilter() {
    ...
    assertThat(completedEvent.getOutputs())
        ...
        .satisfies(
            output -> {
              assertThat(output.getNamespace()).isEqualTo("file");
              assertThat(output.getName()).isEqualTo("/opt/hive/data/warehouse/test.db/xxx");
              ...
              assertThat(
                  ...
                  .satisfies(
                      inputField -> {
                        assertThat(inputField.getNamespace()).isEqualTo("file");
                        assertThat(inputField.getName())
                            .isEqualTo("/opt/hive/data/warehouse/test.db/t1");
              ...
              assertThat(
                  ...
                  .satisfies(
                      inputField -> {
                        assertThat(inputField.getNamespace()).isEqualTo("file");
                        assertThat(inputField.getName())
                            .isEqualTo("/opt/hive/data/warehouse/test.db/t3");
              ...
              assertThat(symlinks.getIdentifiers())
                  ...
                  .satisfies(
                      identifier -> {
                        assertThat(identifier.getNamespace()).isEqualTo("hive");
                        assertThat(identifier.getName()).isEqualTo("test.xxx");
