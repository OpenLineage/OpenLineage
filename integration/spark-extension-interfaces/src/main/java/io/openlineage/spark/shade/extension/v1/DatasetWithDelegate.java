 ...
 *
 * <p>Implementing classes should provide a method to retrieve the node from which an input
 * or output dataset can be extracted. This is used to capture lineage information by
 * identifying the node in the Spark LogicalPlan that corresponds to the dataset.
 */
