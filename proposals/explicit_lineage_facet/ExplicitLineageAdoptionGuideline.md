...
"run": { "facets": { "lineage": { "entries": [
  {"name": "table_c", "inputs": [{"name": "table_a"}]},
  {"name": "table_d", "inputs": [{"name": "table_b"}]}
]}}}
```
...
"dataset": [ { "name": "my_view", "facets": { "lineage": { "entries": [
  "inputs": [{"name": "base_table"}]
]}}}]
```
...
"run": { "facets": { "lineage": { "entries": [
  {"name": "table_c", "field": "column_A", "inputs": [{"name": "table_a", "field": "column_A"}]},
  {"name": "file_d", "inputs": [{"name": "table_b", "field": "column_B"}]}
]}}}
```
