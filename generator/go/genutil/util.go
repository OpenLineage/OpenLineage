...
// LicenseHeader is the copyright banner prepended to every generated file.
const LicenseHeader = `/*
 * Copyright 2018-2026 contributors to the OpenLineage project
 * SPDX-License-Identifier: Apache-2.0
 */
...
// GeneratorHeader is the "do not edit" marker inserted in every generated file.
const GeneratorHeader = "// Code generated by facet-gen. DO NOT EDIT."
