 ...
 * 1) Set a break point in OpenLineageGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class OpenLineageGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("open-lineage") // use this codegen library
              ...
              .setOutputDir("out/open-lineage"); // output directory
