...
perl -i -pe"s/^version=.*/version=${RELEASE_VERSION}/g" ./integration/spark-extension-columnlevel/gradle.properties
...
perl -i -pe"s/^version=.*/version=${NEXT_VERSION}/g" ./integration/spark-extension-columnlevel/gradle.properties
