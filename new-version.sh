...
perl -i -pe"s/^version=.*/version=${RELEASE_VERSION}/g" ./integration/spark-interfaces-scala/gradle.properties
perl -i -pe"s/^version=.*/version=${RELEASE_VERSION}/g" ./integration/spark-interfaces/gradle.properties
...
perl -i -pe"s/^version=.*/version=${NEXT_VERSION}/g" ./integration/spark-interfaces/gradle.properties
